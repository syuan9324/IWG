...
public final class Query {
     ...
     * @return Builder 物件，可以繼續帶參數什麼的。
     */
    public static Builder builder(@NotNull String string, Object... parameters) {
     ...
     */
    public static Query of(@NotNull String queryString, Map<String, ?> parameters) {
     ...
     */
    public static Query of(@NotNull String queryString) {
     ...
     */
    public static Query of(@NotNull String queryString, Object... parameters) {
        return new Builder().append(queryString, parameters).build();
    }

    Query(@NotNull String string) {
        this(string, null);
    }

    Query(@NotNull String string, Map<String, ?> parameters) {
...
//            );
    ...
    public static class Builder {
         ...
         * @return Builder 物件本身，方便繼續串其他參數。
         */
        public Builder appendWhen(boolean test, String queryString, Object... parameters) {
            if (test) {
         ...
         * @return Builder 物件本身，方便繼續串其他參數。
         */
        public Builder append(String queryString, Object... parameters) {
        ...
        private void appendAndPutParameters(StringBuilder queryString, String queryFragment, Object... parameters) {
