...
public class AlwaysEncrypted {
    ...
    private static String connectionUrl = "jdbc:sqlserver://10.100.216.11:1433;encrypt=true;databaseName=PWC_DB;user=sa;password=1qaz!QAZ;columnEncryptionSetting=Enabled;trustServerCertificate=true";

    // The password of the keystore and the key.
    private static char[] keyStoreSecret = "IISI@pwcdb20231231".toCharArray();
