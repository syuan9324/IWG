...
public class ScheduledTaskServiceTest {
    ...
    public ScheduledTaskServiceTest(ConnectionConfigService connectionConfigService, IwgHostsService iwgHostsService, IwgHostsTargetService iwgHostsTargetService, IwgHostsLogsService iwgHostsLogsService) {
